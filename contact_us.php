...
<p class="p2">Goverment Polytechnic Mumbai</p>
<p class="p3">49, Kherwadi,<br>
Ali Yawar Jung Marg, <br>
...
<tr>
	<td>
			...
			<p class="p3">Tel : +XXXX XXX XXX</p>
			<p class="p3">Fax: +XXX XXX XXX </p>
	</td>		
	<td >
    <p class="p2">Email:</p>xxxx@gmail.com<p class="p3"></p><br /><br />
    <p class="p2">Our Social Pages:</p>
  <p class="p3"> <a href="https://www.facebook.com/gpmumbai/">
   <img src="pictures/facebook.png" width="40" height="40"></a> 
   <a href="https://www.instagram.com/gpmumbai.ac.in/"> 
   <img src="pictures/instagram.png" width="55" height="40">
  </a> <a href="https://twitter.com/gpmumbai.ac.in/">
...
<p class="p2"><br>How do I become a member of the GPM Alumni?</p>
<p class="p3">All undergraduates and post graduates of GPM can register as
 our alumni. It is important for alumni to update their particulars for the GPM Alumni
  Directory (Database) by register as a member online.</p>
<!-- <p class="p2"><br>Do I need to pay any fee?</p>

<p class="p3">Yes, but it is only for membership registration. You can choose to pay
 yearly or pay for Life Membership. The fee for yearly paid and life membership are Rs 1000
...
the GPM or by contributing ideas or programmes towards enriching learning 
...
<p class="p2"><br>I am still a student of the GPM, can I take part in alumni 
activities?</p>
<p class="p3">Yes, of course. We believed that the bond between alumni and students
 should begin as soon as the student enters the GPM because you will become
  ...
  training especially in soft skills and career development programmes to raise your
   ...
   achieving excellence for the GPM.
</p>
</div>
<br><br><br><br>
</body>
